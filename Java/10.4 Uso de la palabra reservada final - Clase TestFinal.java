...
Esta palabra tiene diferentes signidicados dependiendo donde
se aplique:
    variables: evita cambiar el valor que almacena la variable
    metodos: evita que se modifique la definicion o el comprtamiento 
...
el ejemplo dec esto es la clase Math es la cual todos los atributos
...
public class TestFinal {
    public static void main(String[] args) {
        final int miDni = 32165478;
        System.out.println("miDNI = " + miDni);
        // miDni = 12345654; <- esto no se puede porque es final 
        // Persona.CONSTANTE_AQUI = 9; al ser tipo final no puede modificarse
